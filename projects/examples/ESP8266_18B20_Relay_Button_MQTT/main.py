...
CONFIG = {
    ...
    "DS18B20_00": b"devices/" + client_id + "/18b20_00",
    "DS18B20_01": b"devices/" + client_id + "/18b20_01",
...
def get_18b20():
    ...
    MESSAGES['DS18B20_00'] = None
    MESSAGES['DS18B20_01'] = None
    global tem1, tem2, roms
    tem1 = False
    tem2 = False
    roms = ds.scan()
    if roms:
        ds.convert_temp()
        temp00 = ds.read_temp(roms[0])
        temp01 = ds.read_temp(roms[1])

        if temp00:
            MESSAGES['DS18B20_00'] = str(temp00)
            tem1 = float(temp00)
        else:
            tem1 = False
            MESSAGES['DS18B20_00'] = None
        ...
        if temp01:
            MESSAGES['DS18B20_01'] = str(temp01)
            tem2 = float(temp01)
        else:
            tem2 = False
            MESSAGES['DS18B20_01'] = None
