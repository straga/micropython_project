...
# Winbond W25Q128 chip: an 16 MB Flash chip
...
FLASH_ID_32 = 0x4016 #W25Q32 memory type and capacity
FLASH_ID_128 = 0x4018 #W25Q128 memory type and capacity
...
class FlashClass(object):
    def __init__(self, spi_bus, flash_cs):

        self.spi_no = spi_bus
        self.pinCS = pyb.Pin(flash_cs, mode = pyb.Pin.OUT_PP)
    ...
    def _available(self):                       # return True if the chip is supported
        ...
        return (FLASH_MFG == manufacturer) and (FLASH_ID_128 == device)
